...
public class Msg {
    ...
    private static final HashMap<String, @Nullable Msg> s_msgMap = new HashMap<String, @Nullable Msg>();
    // maps between command number and the length of the header
    private static final HashMap<Integer, @Nullable Integer> s_headerMap = new HashMap<Integer, @Nullable Integer>();
    // has templates for all message from modem to host
    private static final HashMap<Integer, @Nullable Msg> s_replyMap = new HashMap<Integer, @Nullable Msg>();

    private int m_headerLength = -1;
    private byte @Nullable [] m_data = null;
    ...
    public boolean isUnsolicited() {
        ...
        return !m_definition.containsField("ACK/NACK");
    }
    ...
    public String toString() {
        ...
        for (@Nullable
        Field f : m_definition.getFields().values()) {
            fields.add(f);
        }
        for (Field f : fields) {
     ...
     */
    public static @Nullable Msg s_createMessage(byte[] m_buf, int msgLen, boolean isExtended) {

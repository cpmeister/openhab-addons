...
public abstract class CommandHandler {
     ...
     */
    protected static int s_getGroup(InsteonChannelConfiguration c) {
     ...
     */
    @Nullable
    public static <T extends CommandHandler> T s_makeHandler(String name, HashMap<String, @Nullable String> params,
            DeviceFeature f) {

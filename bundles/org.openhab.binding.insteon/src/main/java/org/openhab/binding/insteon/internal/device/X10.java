...
public class X10 {
    ...
    private static @Nullable <T, E> T s_findKey(HashMap<T, E> map, E value) {
     ...
     */
    private static HashMap<Integer, @Nullable String> s_houseCodeToString = new HashMap<Integer, @Nullable String>();
    /**
     * Map between 4-bit X10 code and the unit code.
     */
    private static HashMap<Integer, @Nullable Integer> s_unitCodeToInt = new HashMap<Integer, @Nullable Integer>();

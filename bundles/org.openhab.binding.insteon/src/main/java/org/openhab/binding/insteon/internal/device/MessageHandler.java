...
public abstract class MessageHandler {
    ...
    HashMap<Integer, @Nullable GroupMessageStateMachine> m_groupState = new HashMap<Integer, @Nullable GroupMessageStateMachine>();
     ...
     */
    public static @Nullable <T extends MessageHandler> T s_makeHandler(String name,
